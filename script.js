...
const translations = {
  ar: {
    ...
    hero_hello: 'مرحباً، أنا', hero_uni: 'مهندس برمجيات أول | خبرة +10 سنوات',
    hero_title: 'أبني <span class="gradient-text">أنظمة برمجية</span><br>قابلة للتوسع وعالية الأداء.',
    hero_desc: 'متخصص في تطوير الويب المتقدم، هندسة النظم، وتطبيقات المؤسسات (ERP). أركز على كتابة كود نظيف، آمن، وقابل للصيانة لتقديم حلول أعمال استثنائية.',
  ...
  en: {
    ...
    hero_hello: 'Hello, I am', hero_uni: 'Senior Software Engineer | 10+ Years Experience',
    hero_title: 'Architecting <span class="gradient-text">Software Systems</span><br>for Scalability & Performance.',
    hero_desc: 'Specialized in advanced web development, system architecture, and Enterprise ERPs. I focus on writing clean, secure, and maintainable code to deliver exceptional business solutions.',
