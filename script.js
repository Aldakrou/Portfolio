...
const translations = {
  ar: {
    ...
    hero_hello: 'مرحباً، أنا', hero_uni: 'طالب ذكاء اصطناعي (Level 2) | جامعة المنصورة الجديدة',
    hero_title: 'أبني <span class="gradient-text">أنظمة برمجية</span><br>قابلة للتوسع وعالية الأداء.',
    hero_desc: 'مطور ويب وعاشق للذكاء الاصطناعي بعمر 20 عاماً وخبرة سنتين. أدمج بين الحلول البرمجية الذكية وتقنيات الويب الحديثة لبناء تطبيقات ومواقع متميزة.',
    hero_btn_work: 'معرض الأعمال', hero_btn_contact: 'تواصل معي', hero_stat1: 'مشروع Enterprise', hero_stat2: 'معدل رضا العملاء', hero_badge: 'متاح للمشاريع',
    projects_tag: 'المشاريع', projects_title: 'أعمالي السابقة', projects_desc: 'تصفح أحدث الأنظمة والتطبيقات التي قمت ببنائها',
    skills_tag: 'الأدوات', skills_title: 'التقنيات المستخدمة', skills_desc: 'الأساس التقني القوي الذي أعتمد عليه لبناء حلول برمجية متكاملة',
    process_tag: 'منهجية العمل', process_title: 'كيف أعمل؟',
    ...
    exp_tag: 'رحلتي المهنية', exp_title: 'سنتين من الشغف والتطور',
    exp1_title: 'طالب تقنيات ذكاء اصطناعي', exp1_desc: 'دراسة وتطبيق مفاهيم الذكاء الاصطناعي (Level 2) في جامعة المنصورة الجديدة.',
    exp2_title: 'مطور ويب حر', exp2_desc: 'تصميم وبناء مواقع تفاعلية باستخدام تقنيات حديثة وتلبية متطلبات العملاء.',
    exp3_title: 'بداية الرحلة', exp3_desc: 'تعلم البرمجة وتطوير مهاراتي المستمر في الواجهات الأمامية والخلفية.',
  ...
  en: {
    ...
    hero_hello: 'Hello, I am', hero_uni: 'Level 2 AI Student | New Mansoura University',
    hero_title: 'Architecting <span class="gradient-text">Software Systems</span><br>for Scalability & Performance.',
    hero_desc: 'A 20-year-old Web Developer and AI enthusiast with 2 years of experience. I bridge smart AI solutions with modern web technologies to build outstanding applications.',
    hero_btn_work: 'View Portfolio', hero_btn_contact: 'Contact Me', hero_stat1: 'Enterprise Projects', hero_stat2: 'Client Satisfaction', hero_badge: 'Available for hire',
    projects_tag: 'Projects', projects_title: 'Previous Work', projects_desc: 'Browse my recent applications and systems',
    skills_tag: 'Tech Stack', skills_title: 'My Technologies', skills_desc: 'The robust technical foundation I rely on to build complete software solutions.',
    process_tag: 'Workflow', process_title: 'How I Work?',
    ...
    exp_tag: 'My Journey', exp_title: '2 Years of Passion & Growth',
    exp1_title: 'AI Technologies Student', exp1_desc: 'Studying and applying AI concepts (Level 2) at New Mansoura University.',
    exp2_title: 'Freelance Web Developer', exp2_desc: 'Designing and building interactive websites using modern web technologies to fulfill client needs.',
    exp3_title: 'The Beginning', exp3_desc: 'Learning programming fundamentals, algorithms, and continuously developing my technical skills.',
